...
export function parseMatchMetadata(
	...
	return {
		...
		disabled_improvements: parseDisabledImprovements(root),
...
// baked wonder table.
function parseDisabledImprovements(root: Record<string, unknown>): string[] {
	const disabled = root.ImprovementDisabled;
