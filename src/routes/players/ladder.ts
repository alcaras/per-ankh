// The /players cognomen ladder: the rungs, and the cognomen a game count earns.
//
...
// a cognomen can't be lost to someone else's grinding, and any number
...
export function cognomenOf(total: number): string | null {
